...
\begin{enumerate}
   ...
   \item \textbf{CARRIER\_CONC} \\ \\
    ...
    \begin{enumerate}
        ...
        %Out of these four input files, two input files, EIGENVAL and OUTCAR files are necessary for simulation. \\
...
% \textbf{Scattering Mechanism} & \textbf{Parameters Needed}
